    ...
    public static void Main(string[] args)
    {
        try
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                Logger.Write($"[Database] LiteDB initialized: {liteDbContext.Messages.Count()} messages");
            }
        ...
        {
            Logger.Write($"[CRITICAL ERROR] Server crashed: {ex.Message}");
            try { Logger.Write(ex.ToString()); } catch { }
        }
    }
