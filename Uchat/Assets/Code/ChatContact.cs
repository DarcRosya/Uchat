        ...
        public partial class MainWindow : Window
        {
            public partial class Chat
            {
                ...
                public class Contact
                {
                    ...
                    {
                        string color = (Chat.GroupsActive == true) ? "#4a8284" : "#4b678a";
                        ...
                        {
                            this.Background = Brush.Parse("#171a20");
                            this.LastMessageForeground = Brush.Parse("#999999");
                            this.StatusBackground = Brush.Parse("#171a20"); 
                        }
                    }
