...
namespace Uchat
{
	...
	public partial class MainWindow : Window
	{
		...
		private void SendButton_Click(object? sender, RoutedEventArgs e)
		{
			...
			//	var replyStackPanel = new StackPanel();
			...
			//	replyStackPanel.Children.Add(replyText);
			...
			{
				newMessage = new Chat.Message(text, timestamp, "received");		
			}
			else
			{
                newMessage = new Chat.Message(text, timestamp, "sended");
            }

			Border bubble = newMessage.Render;
