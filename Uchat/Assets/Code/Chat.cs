	...
	public partial class MainWindow : Window
	{
		...
		private void SendButton_Click(object? sender, RoutedEventArgs e)
		{
			...
			menuItemReply.Click += (s, e) =>
			{
				...
				replyTheMessage.Text = newMessage.Content;
				tempReplyTextBox = newMessage.Content;
			...
			menuItemEdit.Click += (s, e) =>
			{
				...
				editTheMessage.Text = newMessage.Content;
				chatTextBoxForEdit.Text = newMessage.Content;

				textBlockChange = newMessage.ContentTextBlock;
			};
			...
			{
				Clipboard.SetTextAsync(newMessage.Content);
			};
